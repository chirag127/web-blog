...
export const FAMILY_SITES: FamilySite[] = [
  { slug: 'home', name: 'oriz', url: 'https://oriz.in', tagline: 'The hub for the oriz family', emoji: '🏠', category: 'personal' },
  { slug: 'me', name: 'Me', url: 'https://me.oriz.in', tagline: 'Chirag Singhal — daily-rebuilt digital identity datasheet', emoji: '👤', category: 'personal' },
  ...
  { slug: 'book-lore', name: 'Book Lore', url: 'https://book-lore.oriz.in', tagline: '461 book summaries — overview, content, analysis, narration', emoji: '📖', category: 'reading' },
